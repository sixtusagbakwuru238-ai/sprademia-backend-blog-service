...
const ImageWithListSectionSchema = z.object({
  type: z.literal("imageWithList"),
  // Image fields
  imageUrl:  z.string(),
  altText:   z.string(),
  caption:   z.string().optional(),
  ...
  height:    z.number().optional(),
  // List fields
  listTitle: z.string().optional(),           // optional heading above the list
  items:     z.array(z.string()),             // plain text items
